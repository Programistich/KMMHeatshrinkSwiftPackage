...
- (instancetype)initWithArray:(KMMHKotlinByteArray *)array windowSize:(int32_t)windowSize lookaheadSize:(int32_t)lookaheadSize __attribute__((swift_name("init(array:windowSize:lookaheadSize:)"))) __attribute__((objc_designated_initializer));
